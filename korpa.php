...
<nav role="navigation">
            <ul>
              <li><a href="/telefoni-master/index.html">Pocetna</a></li>
              <li><a href="/telefoni-master/korpa.php"><i style="font-size: 20px; color: white;" class="fa fa-shopping-cart"></i></a></li>
              <li><a href="/telefoni-master/prijavi_se.html">Uloguj Se</a></li>
            </ul>
        </nav>
<div id="w">
    ...
    $(".naruci").on('click', function(){
            ...
            let telefon=document.getElementById("telefon").value;
                $.ajax({
                    ...
                    success:function(){
                        location.replace('http://localhost/telefoni-master/index.html')
                }
                });
            }); 
